          ...
          <div className="absolute top-0 bottom-0 left-4 right-4 sm:top-auto sm:right-auto sm:bottom-[140px] md:bottom-[156px] sm:left-4 md:left-12 max-w-xl z-20 flex flex-col justify-end sm:justify-start items-start text-left pb-[31px] sm:pb-0 space-y-2 sm:space-y-4 md:space-y-6">
              ...
              <div className="w-[60%] sm:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-2 md:gap-4">
                <Link href={`/watch/${watchMediaId}${category ? `?category=${category}` : ''}`} className="w-full sm:w-auto">
                  <button className="flex items-center justify-center gap-2 sm:gap-2 bg-white text-black hover:bg-white/90 transition-colors h-11 sm:h-10 md:h-12 w-full sm:w-auto px-4 sm:px-6 md:px-8 rounded font-semibold tracking-wide text-sm sm:text-sm md:text-base cursor-pointer" data-testid="button-watch">
