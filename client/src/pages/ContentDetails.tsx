    ...
    <div className="min-h-screen bg-black text-white selection:bg-white/20">
      ...
      <main>
        ...
        <div className="relative w-full h-[calc(75vh-60px)] sm:h-[calc(75vh-90px)] md:h-[calc(80vh-90px)] lg:h-[calc(90vh-90px)]">
          ...
          <div className="absolute inset-0 sm:inset-auto sm:bottom-[140px] md:bottom-[156px] sm:left-4 md:left-12 left-4 right-4 sm:right-auto max-w-xl z-20 flex flex-col justify-end sm:justify-start items-start text-left pb-[31px] sm:pb-0 space-y-3 sm:space-y-4 md:space-y-6">
