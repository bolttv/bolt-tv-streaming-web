      ...
      <div className="absolute inset-0 z-[5] pointer-events-none">
        <div className="relative h-full w-full max-w-[1400px] mx-auto px-6 md:px-16">
          <img
            ...
            className="absolute right-0 md:right-[30px] w-[396px] md:w-[554px] lg:w-[686px] max-h-[119%] object-contain object-bottom hidden sm:block sm:opacity-60 md:opacity-100"
            style={{ bottom: '360px' }}
          />
        </div>
      </div>
