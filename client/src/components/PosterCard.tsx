    ...
    <Link href={href}>
      ...
      >
        ...
        >
          ...
          {/* Labels */}
          {item.isNewEpisode && (
            <div className="absolute top-2 left-2 bg-[#C14600] text-white text-[9px] md:text-[10px] font-bold px-1.5 py-0.5 rounded-sm uppercase tracking-wider shadow-sm">
              New Episode
            </div>
          )}
