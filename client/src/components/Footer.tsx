      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
             ...
             {/* X (Twitter) - Using Lucide Twitter for now, or SVG for X logo specifically if requested, but Twitter icon is standard fallback often. Let's use a custom SVG for X to be precise as requested. */}
             <div className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 cursor-pointer transition flex items-center justify-center group">
