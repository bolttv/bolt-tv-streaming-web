...
export default function Subscribe() {
  ...
  const isChangingPlan = searchParams.get("changePlan") === "true";
  ...
  }, [isAuthenticated, authStep, router, isChangingPlan]);
  ...
  const handleContinue = () => {
    ...
    router.push(`/checkout?offerId=${encodeURIComponent(selectedPlanData.offerId)}`);
  };
