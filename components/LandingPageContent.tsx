...
const posterGritGlory = "/attached_assets/Grit-Glory-Poster-Web_1771007420672.png";
const posterRookie = "/attached_assets/rookie-web_1771007420673.png";
const posterTraviesa = "/attached_assets/traviesa-web_1771007420674.png";
const posterSurfing = "/attached_assets/ChatGPT_Image_Oct_1,_2025_at_01_26_07_PM_1771007394434.png";
const posterLifeOnIce = "/attached_assets/ChatGPT_Image_Oct_3,_2025,_11_50_56_AM_1771007394435.png";
const posterQuestForGold = "/attached_assets/QuestForGoal-FINAL_1771007348206.jpeg";
const originalsBannerBg = "/attached_assets/GG_BoNix_Background_1771183611134.jpg";
const originalsBannerFront = "/attached_assets/GG_Banner_Foreground_2_1771297935655.png";
const posterFullThrottle = "/attached_assets/ChatGPT_Image_Oct_2,_2025_at_05_43_18_PM_1771007394434.png";
const posterSurfingMidnight = "/attached_assets/SurfingTheMidnightSun-Poster_1771007420673.png";
const sportActionSports = "/attached_assets/Action_Sports-New_1770944151377.png";
const sportBaseball = "/attached_assets/Baseball-New_1770944155832.png";
const sportBasketball = "/attached_assets/Basketball-New_1770944159354.png";
const sportBoxing = "/attached_assets/Boxing-New_1770944162862.png";
const sportFootball = "/attached_assets/Football-New_1770944167300.png";
const sportGaming = "/attached_assets/Gaming-New_1770944173095.png";
const sportGolf = "/attached_assets/Golf-New_1770944179196.png";
const sportHockey = "/attached_assets/Hockey-New_1770944184636.png";
const sportCombat = "/attached_assets/MMA-New_1770944197258.png";
const sportRugby = "/attached_assets/Rugby-New_1770944206484.png";
const logoSamsung = "/attached_assets/Samsung_1770967338626.webp";
const logoAppleTV = "/attached_assets/AppleTV_1770967338626.webp";
const logoPanasonic = "/attached_assets/Panasonic_1770967338626.webp";
const logoChromecast = "/attached_assets/Chromecast_1770967338625.webp";
const logoSony = "/attached_assets/Sony_1770967338625.webp";
const logoLG = "/attached_assets/LG_1770967338625.webp";
const logoRoku = "/attached_assets/Roku_1770967338626.webp";
const logoAmazonFire = "/attached_assets/AmazonFire_1770967338627.webp";
const logoGooglePlay = "/attached_assets/GooglePlay_1770967338627.webp";
const logoAppStore = "/attached_assets/AppStore_1770967338627.webp";
const logoPS5 = "/attached_assets/PS5_1770967338625.webp";
const logoXbox = "/attached_assets/XBOX_1770967338628.webp";
const logoAndroidTV = "/attached_assets/AndroidTV_1770967338628.webp";
const logoHisense = "/attached_assets/Hisense_1770967338627.webp";
...
const ScrollingPosterBackground = memo(function ScrollingPosterBackground({ posters }: { posters: { img: string; title: string }[] }) {
  ...
  const [columns, setColumns] = useState<{ img: string; title: string }[][]>([]);
...
function OriginalsBanner() {
  return (
    <section className="relative h-[420px] sm:h-[550px] md:h-[700px] lg:h-[800px]" data-testid="section-originals-banner">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-16">
        <div className="max-w-2xl mb-6 sm:mb-10 md:mb-14">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-display font-black text-white uppercase leading-tight mb-4">
            Exclusive<br />Originals
          </h2>
          <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed mb-6 max-w-md">
        ...
        <div className="pb-6 sm:pb-14">
          <div className="flex gap-2 sm:gap-3 md:gap-4 overflow-x-auto scrollbar-hide">
            {originalPosters.map((poster, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-[120px] sm:w-[180px] md:w-[239px] rounded-lg overflow-hidden"
...
export default function LandingPage() {
  ...
  }, [isAuthenticated, authStep, isLoading, router]);
  ...
  const handleGetStarted = () => {
    ...
    setEmailError("");
    router.push(`/subscribe?email=${encodeURIComponent(email.trim())}`);
  };
